...
const swiper = new Swiper('.swiper', {
  ...
  // If you want the slides to stop auto sliding on mouse hover
...
function showSlides(n) {
    ...
    for (i = 0; i < slides.length; i++) {
        ...
        slides[i].style.opacity = 0.3; // Make non-active slides less visible
    }
    slides[slideIndex-1].className += " active";
    slides[slideIndex-1].style.opacity = 1; // Fully visible and scaled
}
